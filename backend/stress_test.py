...
ESCENARIOS = {
    ...
    # ── Escenarios específicos de México ─────────────────────────
    "amlo_2018": {
        "nombre": "Elección 2018 / NAIM",
        "emoji": "🇲🇽",
        "descripcion": "Cancelación del aeropuerto de Texcoco (oct 2018). IPC cae ~15%, peso -10%, bancos y aerolíneas golpeadas.",
        "duracion": "2-3 meses",
        "shocks_default": {
    ...
    "covid_mx_2020": {
        "nombre": "COVID en México (Mar-Abr 2020)",
        "emoji": "😷",
        "descripcion": "Crisis sanitaria local. IPC -25%, USD/MXN sube a 25 (+25%), turismo y aviación a la lona.",
        "duracion": "3-6 meses",
        "shocks_default": {
            "Industrials":        -0.40,   # aeropuertos, GAP/ASUR
            "Consumer Cyclical":  -0.35,   # ALSEA, comercio
    ...
    "elecciones_2024": {
        "nombre": "Súper mayoría 2024",
        "emoji": "🗳️",
        "descripcion": "Resultado electoral con súper mayoría legislativa. IPC -8% en una semana, peso -10%, bancos y telecoms presionados por reformas.",
    ...
    "aranceles_trump": {
        "nombre": "Aranceles Trump a MX",
        "emoji": "🔻",
        "descripcion": "Imposición de aranceles 25% a productos mexicanos. Automotriz, manufactura y aerolíneas golpeadas. Peso a 22+.",
        "duracion": "3-6 meses",
        "shocks_default": {
            "Consumer Cyclical":  -0.25,   # automotriz (Nemak)
            "Industrials":        -0.22,   # manufactura
